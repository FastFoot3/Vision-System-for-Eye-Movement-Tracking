...
% Tutaj zacznę od opisania krok po kroku technicznego działania programu bazując na diagramie UML, w formie syntezy opiszę jakie informację są pomiędzy sobą przekazywane i ich kierunek z zaznaczeniem momentów gdy dany moduł wymienia się info, czyli: gdzie są ustawione klocki, jak klocki z sobą rozmawiają i jak idzie głuchy telefon. Jeżeli będą jakieś obliczenia to opiszę dlaczego zostały wykonane.
