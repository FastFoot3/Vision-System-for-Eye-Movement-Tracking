...
\begin{enumerate}
	...
	\item W sekcji \ref{subsec:zakres-dzialania-systemu} wymieniono różne funkcjonalności programu, część z nich z reguły nie będzie działać równolegle, wymaga to więc prostego sposobu na kontrolowanie, która z użyteczności będzie w tym momencie wykorzystywana. 
