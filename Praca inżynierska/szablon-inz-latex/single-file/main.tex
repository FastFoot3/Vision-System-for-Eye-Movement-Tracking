...
%
%
% TODO: architektura systemu, opis struktur danych, komponenty itp. (jeśli występują), przegląd ważniejszych algorytmów (jeśli występują), szczegóły implementacji wybranych fragmentów, diagramy UML
%
% Status: 30%
%--------------------------------------
