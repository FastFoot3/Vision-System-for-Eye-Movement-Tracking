...
% w zasadzie trzeba było by to sprawdzić na wirtualce, albo można napisać od czapy że ma wymagania takie jak pyinstaller + kamera, wyświetlacz
...
\begin{description}
	...
	\item[q (wyłączenie programu) --] jedyny poprawny sposób na zatrzymanie systemu, po nacisnieciu bezpiecznie zamyka plik tekstowy z pomiarami, zwalnia kamerę i zamyka wszystkie okna programu.
\end{description}
