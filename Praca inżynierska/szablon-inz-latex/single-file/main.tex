...
Drugą podstawową operacją morfologiczną jest dylatacja, będąca odwrotnością erozji. Jeśli choć jeden piksel znajdujący się pod elementem strukturalnym ma wartość $1$, punkt centralny również przyjmuje wartość $1$. Proces ten powoduje powiększenie obiektów, tworząc dodatkową warstwę na ich krawędziach.
