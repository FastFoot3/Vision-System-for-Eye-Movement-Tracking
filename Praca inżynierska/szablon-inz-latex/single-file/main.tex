...
%
%
% TODO: organizacja eksperymentów?, przypadki testowe zakres testowania, wykryte i usunięte błędy, opcjonalnie wyniki badań eksperymentalnych
%
% Status: 10%
%--------------------------------------
...
W przypadku wszystkich testów używano tego samego sprzętu opisanego w podrozdziale \ref{sec:Narzedzia-i-metody-wykorzystane-w-pracy}, za wyjątkiem testu plików wykonywalnych, których działanie potwierdzono przy użyciu innego laptopa. 
