...
ax1_eye_0.plot(eye_0_data['time'], eye_0_data['X_Displacement'], marker='o', linestyle='-', color=colors[0])
ax1_eye_0.set_ylabel('X Displacement')
ax1_eye_0.set_title('X Displacement vs Time (Eye 0)')
ax1_eye_0.grid(True)

ax2_eye_0.plot(eye_0_data['time'], eye_0_data['Y_Displacement'], marker='o', linestyle='-', color=colors[0])
